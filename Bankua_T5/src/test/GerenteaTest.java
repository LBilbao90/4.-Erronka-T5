...
public class GerenteaTest {
    ...
    public void testGerenteaConsGet() {
    	...
    	Gerentea g1 = new Gerentea("12345678A", "Juan", "Perez", "10-21-2002", "gizona", "111222333", "12345678", "Gerentea", sukurtsalak);
    ...
    @Test
	public void testGerenteaToString() {
    	DiruSarrera ds1 = new DiruSarrera(100, "03-19-2023", "sarrera", "ES1245784512346751245124");
    	...
    	// ToString
    	assertEquals("Pertsona nan=" + g1.getNan() + ", izena=" + g1.getIzena() + ", abizena=" + g1.getAbizena() + ", jaiotzeData=" + g1.getJaiotzeData()
		+ ", sexua=" + g1.getSexua() + ", telefonoa=" + g1.getTelefonoa() + ", pasahitza=" + g1.getPasahitza() + ", Lanpostu=" + g1.getLanpostu() + ", Sukurtsalak=" + g1.getSukurtsalak(), g1.toString());
    }
    
    @Test
	public void testGerenteaEquals() {
    	DiruSarrera ds1 = new DiruSarrera(100, "03-19-2023", "sarrera", "ES1245784512346751245124");
    	...
    	Gerentea g1 = new Gerentea("12345678A", "Juan", "Perez", "10-21-2002", "gizona", "111222333", "12345678", "Gerentea", sukurtsalak);
    	Gerentea g2 = new Gerentea("12345678A", "Juan", "Perez", "10-21-2002", "gizona", "111222333", "12345678", "Gerentea", sukurtsalak);
    	Gerentea g3 = new Gerentea();
